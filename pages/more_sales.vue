        ...
        <div class="home-container">
            <div class="">
                ...
                <div class="col-sm-12 col-md-12 col-lg-4 mb-2" v-for="(info,index) in filterAll" :key="index">
                    ...
                    <div class="text-center mt-5" v-if="salesItems.length">
...
export default {
    data(){
        ...
        filterAll(){
            try{
                return this.salesItems.filter((post)=>{
                    return(
    ...
    methods:{
    getSalesItems(){
        this.$axios.get("https://jayceeandjay.online/sales", {headers : {'Content-Type':'application/json'}}).then((res)=> {
